...
corrected <- batch_correct(
  ...
  som_type = "fsom" # "kohonen" is recommended when combining distinct data with heavy batch effects
)
...
labels <- uncorrected %>% 
  ...
  create_som(markers = markers,
             som_type = "kohonen", # Consider using som_type = "fsom" with norm_method = "scale", when combining similar data
             seed = 101,
             xdim = 8,
             ydim = 8)
