...
```{r cluster total-seq, message = FALSE, fig.height=5, fig.width=8}
...
```{r emd, message=FALSE, fig.height=4, fig.width=4}
...
```{r density plot, message=FALSE, fig.height=5, fig.width=16}
...
```{r umaps, fig.height=9, fig.width=16}
plots <- plot_umap_labels(uncorrected, corrected)

plots[[1]]
```

```{r umaps2, fig.height=4, fig.width=12}
plots[[2]]
```
