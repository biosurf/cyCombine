...
Here, it is seen that the sample cell type fractions correlate nicely with the counterpart from the other technology. However, we do have some clusters, e.g. cluster 9, where the fractions are consistently larger for one technology.
