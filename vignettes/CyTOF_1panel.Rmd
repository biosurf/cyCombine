...
This vignette will demonstrate the batch correction of a CyTOF set consisting of 126 samples in seven batches using cyCombine.
...
<br>
This is data from a study of CLL patients and healthy donors at the Dana-Farber Cancer Institute (DFCI). The protein expression was quantified using mass cytometry for 126 samples (20 healthy donors). The data was run in seven batches.
