...
[EMD](images/emd_per_marker.png){width=500px}
...
[Distributions](images/distributions_per_batch.png){width=500px}
...
[MDS](images/MDS_per_batch.png){width=500px}
...
```{r umaps, fig.height=6, fig.width=12}
