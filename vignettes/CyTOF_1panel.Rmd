...
One example could be to cluster the dataset. Here, we will display the results of Phenograph clustering. Actually, I will compare Phenograph run for all eight batches *with* and *without* batch correction using the same set of markers.
