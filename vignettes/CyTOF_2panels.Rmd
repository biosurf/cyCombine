...
plot1 <- plot_dimred(dfci1[sample1,], name = 'Uncorrected', type = 'umap')
plot2 <- plot_dimred(dfci1_bc[sample1,], name = 'Corrected', type = 'umap')
...
plot1 <- plot_dimred(dfci2[sample2,], name = 'Uncorrected', type = 'umap')
plot2 <- plot_dimred(dfci2_bc[sample2,], name = 'Corrected', type = 'umap')
...
```{r density plots 1, fig.height=8, fig.width=12}
...
```{r density plots 2, fig.height=24, fig.width=12}
