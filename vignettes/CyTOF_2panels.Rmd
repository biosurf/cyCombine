...
# Panel 1 reading
panel1 <- read_csv("dfci1_2/panel1.csv")
panel1

# Panel 2 reading
panel2 <- read_csv("dfci2_2/panel2.csv")
panel2
...
dfci1 <- prepare_data(data_dir = "dfci1_2",
                      metadata = "dfci1_2/metadata.csv",
...
# Preparing the expression data
dfci2 <- prepare_data(data_dir = "dfci2_2",
                      metadata = "dfci2_2/metadata.csv",
                      filename_col = "FCS_name",
                      batch_ids = "Batch",
                      condition = "Set",
                      markers = markers2,
...
For both panels, we find EMD reductions of 0.67 and 0.65, respectively, when considering the batch corrections separately.
